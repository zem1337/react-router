  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/movies' element={<MovieList movies={movies} titre={titre} etoile={etoile} setMovies={setMovies}/>}/>
        <Route path='/movie/:space' element={<MoviePage movies={movies}/>}/>
      </Routes>
    </div>
  );
} 
